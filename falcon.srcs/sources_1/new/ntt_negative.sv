...
module ntt_negative#(
  ...
  logic mod_mult_valid_in, mod_mult_valid_out, mod_mult_last; // Valid signals for mod_mult module
  ...
  function [14:0] mod_mult_f(input logic signed [14:0] a, b);
    ...
    begin
      ...
      mod_mult_f = (temp1 >= 12289) ? (temp1 - 12289) : temp1;
    end
  endfunction
  ...
  always_comb begin
    case (state)
      ...
      COPY_FROM_INT: begin // Copy intermediate polynomial to output polynomial. This takes just one cycle
        next_state = DONE;
      end
      DONE: begin
        next_state = IDLE;
