...
module fft#(
    ...
    output logic [`FFT_BRAM_ADDR_WIDTH-1:0] bram1_addr_a,
    output logic [`FFT_BRAM_ADDR_WIDTH-1:0] bram1_addr_b,
    ...
    output logic [`FFT_BRAM_ADDR_WIDTH-1:0] bram2_addr_a,
    output logic [`FFT_BRAM_ADDR_WIDTH-1:0] bram2_addr_b,
