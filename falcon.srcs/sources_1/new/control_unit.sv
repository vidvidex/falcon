...
module control_unit#(
  ...
  always_comb begin
    ...
    for (int i = BRAM2048_COUNT; i < BRAM1024_COUNT+BRAM2048_COUNT; i++) begin
      bram1024_addr_a[i] = bram_addr_a[i][`BRAM1024_ADDR_WIDTH-1:0];
      bram1024_addr_b[i] = bram_addr_b[i][`BRAM1024_ADDR_WIDTH-1:0];
    end
  end
