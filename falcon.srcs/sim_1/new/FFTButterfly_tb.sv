...
module FFTButterfly_tb;
  ...
  initial begin
    ...
    // tw_real = $realtobits(1.0);
    // tw_imag = $realtobits(0.0);
    // #10;    // output: 3+3i; -1-1i -----needs to be scaled by 1/N----> 1.5+1.5i, -0.5-0.5i
    ...
    // tw_real = $realtobits(1.0);
    // tw_imag = $realtobits(0.0);
    // #10;    // output: 5.5+7.3i; -3.5-2.7i -----needs to be scaled by 1/N----> 2.75+3.65i, -1.75-1.35i
    ...
    // tw_real = $realtobits(1.0);
    // tw_imag = $realtobits(0.0);
    // #10;    // output: 9+9i; 1+1i -----needs to be scaled by 1/N----> 4.5+4.5i, 0.5+0.5i
