...
module ifft_1024_tb;
  ...
  fft_bram_1024_preinit_for_tb fft_bram_1024_preinit_for_tb_1 (
                                 .addra(bram1_addr_a),
                                 .clka(clk),
                                 .dina(bram1_din_a),
                                 .douta(bram1_dout_a),
  ...
  fft_bram_1024_preinit_for_tb fft_bram_1024_preinit_for_tb_2 (
                                 .addra(bram2_addr_a),
                                 .clka(clk),
                                 .dina(bram2_din_a),
                                 .douta(bram2_dout_a),
  ...
  initial begin
    ...
    if(!double_equal(a_real_double, 255.500000))
      $fatal(1, "IFFT 1024: Expected first real part to be 255.500000, got %f", a_real_double);

    a_imag_double = $bitstoreal(bram2_out_a_imag);
    if(!double_equal(a_imag_double, 767.500000))
