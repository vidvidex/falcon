...
module fft_512_tb;
  ...
  logic bram1_we_b;
  bram_6144x128_preinit_for_fft512_tb bram_6144x128_preinit_for_fft_tb_1 (
                                .addra(bram1_addr_a),
                                .clka(clk),
                                .dina(bram1_din_a),
                                .douta(bram1_dout_a),
  ...
  logic bram2_we_b;
  bram_6144x128_preinit_for_fft512_tb bram_6144x128_preinit_for_fft_tb_2 (
                                .addra(bram2_addr_a),
                                .clka(clk),
                                .dina(bram2_din_a),
                                .douta(bram2_dout_a),
  ...
  initial begin
    ...
    if(!double_equal(b_real_double, -5646.553417))
      $fatal(1, "FFT 512: Expected last real part to be -5646.553417, got %f", b_real_double);

    b_imag_double = $bitstoreal(bram1_out_b_imag);
    if(!double_equal(b_imag_double, -27813.556865))
      $fatal(1, "FFT 512: Expected last imag part to be -27813.556865, got %f", b_imag_double);
