...
create_clock -period 8.0 [get_ports FPGA_CLK125_P]
...
set_property PACKAGE_PIN AH14 [get_ports {btns[0]}]; #Bank 44, BTN0
set_property PACKAGE_PIN AG14 [get_ports {btns[1]}]; #Bank 44, BTN1
set_property PACKAGE_PIN AE14 [get_ports {btns[2]}]; #Bank 44, BTN2
set_property PACKAGE_PIN AE15 [get_ports {btns[3]}]; #Bank 44, BTN3
set_property IOSTANDARD LVCMOS12 [get_ports {btns[*]}];
## led_4bits_tri_o
set_property PACKAGE_PIN B5 [get_ports {leds[0]}]; #Bank 66, LED0
set_property PACKAGE_PIN A6 [get_ports {leds[1]}]; #Bank 66, LED1
set_property PACKAGE_PIN B8 [get_ports {leds[2]}]; #Bank 66, LED2
set_property PACKAGE_PIN A7 [get_ports {leds[3]}]; #Bank 66, LED3
